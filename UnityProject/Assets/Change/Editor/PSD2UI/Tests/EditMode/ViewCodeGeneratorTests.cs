...
namespace Change.Editor.PSD2UI.Tests
{
    ...
    public class ViewCodeGeneratorTests
    {
        ...
        public void GenerateClass_WithComponents_ContainsFieldDeclarations()
        {
            ...
            var components = new List<ViewComponentInfo>
            {
                new ViewComponentInfo { Name = "Close", Type = "Button", EventType = "onClick" }
            };
        ...
        public void GenerateClass_WithComponents_ContainsPartialMethod()
        {
            ...
            var components = new List<ViewComponentInfo>
            {
                new ViewComponentInfo { Name = "Volume", Type = "Slider", EventType = "onValueChanged" }
            };
        ...
        public void GenerateClass_MultipleComponents_GeneratesAllFieldsAndBindings()
        {
            ...
            {
                new ViewComponentInfo { Name = "Close", Type = "Button", EventType = "onClick" },
                new ViewComponentInfo { Name = "Sound", Type = "Toggle", EventType = "onValueChanged" },
                new ViewComponentInfo { Name = "Volume", Type = "Slider", EventType = "onValueChanged" }
            };
        ...
        public void GenerateClass_FieldNameFollowsPrefixPascalCaseConvention()
        {
            ...
            var components = new List<ViewComponentInfo>
            {
                new ViewComponentInfo { Name = "submit", Type = "Button", EventType = "onClick" }
            };
        ...
        public void GenerateViewCode_ValidatesOutputCodeCompiles()
        {
            ...
            var components = new List<ViewComponentInfo>
            {
                new ViewComponentInfo { Name = "OK", Type = "Button", EventType = "onClick" },
                new ViewComponentInfo { Name = "Cancel", Type = "Button", EventType = "onClick" },
                new ViewComponentInfo { Name = "Music", Type = "Toggle", EventType = "onValueChanged" }
            };
